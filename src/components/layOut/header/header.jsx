...
function Header({ theme, setTheme }) {
    ...
    return (
        <header className="sticky top-0 z-50 font-mono text-white bg-white shadow-md dark:bg-black dark:bg-opacity-70 bg-opacity-30 backdrop-filter backdrop-blur-lg font-sanst-semibold " >
